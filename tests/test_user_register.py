...
class TestUserRegister(BaseCase):
    ...
    def test_create_user_with_incorrect_email(self):  # Негативный тест что юзер без @ не может быть создан
    ...
    def test_create_user_with_incorrect_firstname(self):  # Негативный тест что юзер > 250 символов не может быть создан
        base_path = 'learnqa'
        domain = 'example.com'
        random_part = datetime.now().strftime('%m%d%y%H%M%S')
